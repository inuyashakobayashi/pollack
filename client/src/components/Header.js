    ...
    <Navbar bg="light" expand="lg">
      ...
      <Navbar.Collapse id="basic-navbar-nav" className="justify-content-center">
        ...
        <a href="index.html">
            ...
            <ul id='navbar'> 
          <li><Nav.Link as={Link} to="/" className='custom-nav-link' >Home</Nav.Link></li>
          <li><Nav.Link as={Link} to="/vote" className='custom-nav-link'>Vote</Nav.Link></li>
          <li><Nav.Link as={Link} to="/poll" className='custom-nav-link'>Poll</Nav.Link></li>
          </ul>
